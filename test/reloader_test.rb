...
class ReloaderTest < ActiveSupport::TestCase
  ...
  test "redraws importmap when config changes" do
    ...
    assert_changes -> { Rails.application.importmap.packages.keys.sort }, from: ["md5"], to: ["@app/bootstrap", "@components/app_shell", "@components/status_panel", "@legacy/module_compat", "@legacy/packs/application", "application", "packs/application", "react", "react-dom", "react-dom/client", "rich_text", "scheduler"] do
      touch_config
